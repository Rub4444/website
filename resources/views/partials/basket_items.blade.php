<table class="table align-middle ">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex align-items-center">
                    <button class="btn btn-outline-danger btn-sm me-2 btn-remove" data-id="{{ $sku->id }}">−</button>
                    <input type="number" value="{{ $sku->countInOrder }}" class="form-control form-control-sm text-center" style="width: 60px;" readonly>
                    <button class="btn btn-outline-success btn-sm ms-2 btn-add" data-id="{{ $sku->id }}">+</button>
                </div>
            </td>
