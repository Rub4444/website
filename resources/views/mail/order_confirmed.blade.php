...
<style>
    ...
    h2 { color: #2c3e50; }
    p { line-height: 1.6; }
    .btn { display:inline-block; padding:10px 20px; margin-top:15px; background-color:#27ae60; color:#fff; text-decoration:none; border-radius:6px; font-weight:bold; }
...
<div class="container">
    ...
    <div class="content">
        ...
        @if($order->delivery_type === 'pickup')
            <p>📍 Կարող եք մոտենալ խանութ սրահ։</p>
        @else
            <p>🚚 Առաքիչը ճանապարհին է։</p>
        @endif

        <a href="https://ijevanmarket.am" class="btn">Մուտք գործել Իջևան Մարկետ</a>

        <p>✨ Շնորհակալություն գնումների համար և մաղթում ենք հաճելի օր։</p>
    </div>
    <div class="footer">
